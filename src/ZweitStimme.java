...
public class ZweitStimme {
	...
	finanzen.addAll(Arrays.asList("Finanzen", "Steuern", "Finanzpolitik", "Steuerpolitik", "Steuer"));
	if (finanzen.contains(themen)) {
		result = SteuernundFinanzen.getText(partei);
	}	
	ArrayList<String> sicherheit = new ArrayList<String>();
	sicherheit.addAll(Arrays.asList("innere Sicherheit", "Militär", "Terror", "Bundeswehr", "Verteidigung", "Schutz der Bevölkerung"));
	...
	bildung.addAll(Arrays.asList("Bildung", "Digitalisierung", "Kita", "Kindergarten", "Schulbildung", 
			"Schule", "Ausbildung", "Universität", "Forschung", "Schulsystem", "Hochschule", "Studium"));
	...
	arbeitundsoziales.addAll(Arrays.asList("Arbeit", "Arbeitslosigkeit", "Familenpolitik", "Familie", "Kinder", "Kindergeld", 
			"Arbeitslosengeld", "Eltern", "Rente", "Krankenversicherung", "Gesundheit", "Rentenversicherung", "Ehe"));
